...
<head>
  ...
  <title>Your Warp Cheats License Key</title>
</head>
    ...
    <tr>
      <td align="center" style="padding: 40px 20px;">
        <table width="600" cellpadding="0" cellspacing="0" style="max-width: 600px; background-color: #0a0a0a;">
          ...
          <!-- Header -->
          <tr>
            <td align="center" style="padding: 30px 0; border-bottom: 2px solid #90bdf8;">
              <h1 style="margin: 0; font-size: 32px; font-weight: bold; color: #90bdf8;">WARP CHEATS</h1>
          ...
          <tr>
            <td style="padding: 40px 30px;">
              ...
              <!-- License Key Box -->
              <table width="100%" cellpadding="0" cellspacing="0" style="background-color: #1a1a1a; border: 2px solid #90bdf8; border-radius: 8px; margin: 30px 0;">
                <tr>
                  <td align="center" style="padding: 30px 20px;">
                    ...
                    <p style="margin: 0 0 20px 0; font-size: 18px; font-weight: bold; color: #90bdf8; line-height: 1.6;">Open a ticket in our Discord server to receive your license key</p>
                    <a href="https://discord.gg/warpcheats" style="display: inline-block; background-color: #90bdf8; color: #ffffff; text-decoration: none; padding: 15px 40px; border-radius: 6px; font-size: 16px; font-weight: bold; margin-top: 10px;">Open Discord Ticket</a>
              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="background-color: #1a1a1a; border-radius: 8px; margin: 30px 0;">
                <tr>
                  <td style="padding: 25px;">
                    <h2 style="margin: 0 0 20px 0; color: #90bdf8; font-size: 20px;">Order Details</h2>
              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="background-color: #1a1a1a; border-radius: 8px; margin: 30px 0;">
                <tr>
                  <td style="padding: 25px;">
                    <h2 style="margin: 0 0 20px 0; color: #90bdf8; font-size: 20px;">Next Steps</h2>
                          ...
                          <table cellpadding="0" cellspacing="0">
                            <tr>
                              <td width="40" valign="top">
                                <div style="width: 30px; height: 30px; background-color: #90bdf8; color: #fff; border-radius: 50%; text-align: center; line-height: 30px; font-weight: bold;">1</div>
                              </td>
                      ...
                      <tr>
                        <td style="padding: 12px 0;">
                          <table cellpadding="0" cellspacing="0">
                            <tr>
                              <td width="40" valign="top">
                                <div style="width: 30px; height: 30px; background-color: #90bdf8; color: #fff; border-radius: 50%; text-align: center; line-height: 30px; font-weight: bold;">2</div>
                              </td>
                      ...
                      <tr>
                        <td style="padding: 12px 0;">
                          <table cellpadding="0" cellspacing="0">
                            <tr>
                              <td width="40" valign="top">
                                <div style="width: 30px; height: 30px; background-color: #90bdf8; color: #fff; border-radius: 50%; text-align: center; line-height: 30px; font-weight: bold;">3</div>
                              </td>
                      ...
                      <tr>
                        <td style="padding: 12px 0;">
                          <table cellpadding="0" cellspacing="0">
                            <tr>
                              <td width="40" valign="top">
                                <div style="width: 30px; height: 30px; background-color: #90bdf8; color: #fff; border-radius: 50%; text-align: center; line-height: 30px; font-weight: bold;">4</div>
                              </td>
              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="margin: 30px 0;">
                <tr>
                  <td align="center">
                    <a href="https://discord.gg/warpcheats" style="display: inline-block; background-color: #90bdf8; color: #ffffff; text-decoration: none; padding: 15px 40px; border-radius: 6px; font-size: 16px; font-weight: bold;">Open Discord Ticket Now</a>
                  </td>
                </tr>
              </table>
              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="margin: 30px 0;">
                <tr>
                  <td style="padding: 20px; background-color: #1a1a1a; border-radius: 8px;">
                    ...
                    <p style="margin: 0; color: #999; font-size: 14px; line-height: 1.6;">Your order number is <strong style="color: #90bdf8;">${orderNumber}</strong>. You'll need this when opening a ticket in Discord to receive your license key.</p>
                  </td>
                </tr>
              </table>
            </td>
          ...
          <tr>
            <td align="center" style="padding: 30px 20px; border-top: 2px solid #333;">
              <p style="margin: 0 0 10px 0; color: #666; font-size: 14px;">&copy; ${new Date().getFullYear()} Warp Cheats. All rights reserved.</p>
              <p style="margin: 0; color: #666; font-size: 14px;">
                <a href="https://warpcheats.com" style="color: #90bdf8; text-decoration: none;">Visit Website</a> | 
                <a href="https://discord.gg/warpcheats" style="color: #90bdf8; text-decoration: none;">Discord</a>
              </p>
            </td>
          </tr>
    ...
    if (process.env.SMTP_USER && process.env.SMTP_PASS) {
      try {
        await transporter.sendMail({
          from: `"Warp Cheats" <${process.env.SMTP_USER}>`,
          to: customerEmail,
          subject: `Your Warp Cheats License Key - Order #${orderNumber}`,
          html: emailHtml,
        })
